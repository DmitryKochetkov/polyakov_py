...
problem24_files = { 
    ...
    24: './data/24data/k7data/k7a-4.txt',
    26: './data/24data/k7data/k7a-6.txt',
    27: './data/24data/k7data/k7b-1.txt',
    52: './data/24data/k8data/k8-0.txt',
    53: './data/24data/k8data/k8-4.txt',
    54: './data/24data/k8data/k8-6.txt',
    55: './data/24data/k8data/k8-12.txt',
    56: './data/24data/k8data/k8-18.txt',
    57: './data/24data/k8data/k8-20.txt',
    58: './data/24data/k8data/k8-25.txt',
    59: './data/24data/k8data/k8-31.txt',
    60: './data/24data/k8data/k8-48.txt',
    61: './data/24data/k8data/k8-52.txt',
    62: './data/24data/k8data/k8-55.txt',
    63: './data/24data/k8data/k8-69.txt',
    64: './data/24data/k8data/k8-75.txt',
    65: './data/24data/k8data/k8-80.txt',
    66: './data/24data/k8data/k8-84.txt',
    67: './data/24data/k8data/k8-91.txt',
    68: './data/24data/k8data/k8-94.txt',
    69: './data/24data/k8data/k8-96.txt',
    70: './data/24data/k8data/k8-97.txt',
    71: './data/24data/k8data/k8-100.txt',
